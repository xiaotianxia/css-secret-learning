        ...
        <ul>
            <li>
                <div class="container">
                    <h3>blur(模糊)</h3>
                    <div class="img">
                        <img :style="blurStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: blur(<span>{{blur}}</span>px);
            ...
            <li>
                <div class="container">
                    <h3>brightness(亮度)</h3>
                    <div class="img">
                        <img :style="brightnessStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: brightness(<span>{{brightness}}</span>);
            ...
            <li>
                <div class="container">
                    <h3>contrast(对比度)</h3>
                    <div class="img">
                        <img :style="contrastStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: contrast(<span>{{contrast}}</span>%);
            ...
            <li>
                <div class="container">
                    <h3>grayscale(灰度)</h3>
                    <div class="img">
                        <img :style="grayscaleStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: grayscale(<span>{{grayscale}}</span>%);
            ...
            <li>
                <div class="container">
                    ...
                    <div class="img">
                        <img :style="huerotateStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: hue-rotate(<span>{{huerotate}}</span>deg);
            ...
            <li>
                <div class="container">
                    <h3>invert(反转)</h3>
                    <div class="img">
                        <img :style="invertStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: invert(<span>{{invert}}</span>%);
            ...
            <li>
                <div class="container">
                    <h3>opacity(透明度)</h3>
                    <div class="img">
                        <img :style="opacityStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: opacity(<span>{{opacity}}</span>%);
            ...
            <li>
                <div class="container">
                    <h3>saturate(饱和度)</h3>
                    <div class="img">
                        <img :style="saturateStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: saturate(<span>{{saturate}}</span>%);
            ...
            <li>
                <div class="container">
                    <h3>sepia(深褐色)</h3>
                    <div class="img">
                        <img :style="sepiaStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
...
filter: sepia(<span>{{sepia}}</span>%);
            ...
            <li>
                <div class="container">
                    ...
                    <div class="img">
                        <img :style="dropshadowStyle" src="../../static/img/tiger.jpg">
                    </div>
                    <div class="control">
        ...
        {{dropshadow}}px 5px #000</span>);
            ...
            <li class="mixed">
                <div class="container">
                    <h3>混合效果</h3>
                    <div class="img">
                        <img :style="mixedStyle" src="../../static/img/tiger.jpg">
                    </div>
                </div>
            </li>
        </ul>
